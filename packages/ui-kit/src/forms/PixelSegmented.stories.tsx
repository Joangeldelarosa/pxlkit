...
/* eslint-disable */
/**
 * AUTO-GENERATED stub story for PixelSegmented.
...
import * as Component from './PixelSegmented';
import manifest from './PixelSegmented.manifest';
import * as examples from './PixelSegmented.examples';

const meta: Meta = {
  title: 'UI Kit / Forms / PixelSegmented',
  component: (Component as any).PixelSegmented ?? (Component as any).default,
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          (manifest as any)?.description ?? 'PixelSegmented — generated stub.',
      },
    },
    manifest,
  },
    ...
    if (!ExampleComponent) {
      return (
        <pre style={{ color: 'crimson' }}>
          {"Missing example 'default' for PixelSegmented."}
        </pre>
      );
    }
...
export const Controlled: Story = {
  ...
  render: () => {
    ...
    if (!ExampleComponent) {
      return (
        <pre style={{ color: 'crimson' }}>
          {"Missing example 'controlled' for PixelSegmented."}
        </pre>
      );
    }
    return <ExampleComponent />;
...
export const Tones: Story = {
  ...
  render: () => {
    ...
    if (!ExampleComponent) {
      return (
        <pre style={{ color: 'crimson' }}>
          {"Missing example 'tones' for PixelSegmented."}
        </pre>
      );
    }
    return <ExampleComponent />;
...
export const Surfaces: Story = {
  ...
  render: () => {
    ...
    if (!ExampleComponent) {
      return (
        <pre style={{ color: 'crimson' }}>
          {"Missing example 'surfaces' for PixelSegmented."}
        </pre>
      );
    }
    return <ExampleComponent />;
...
export const Disabled: Story = {
  ...
  render: () => {
    ...
    if (!ExampleComponent) {
      return (
        <pre style={{ color: 'crimson' }}>
          {"Missing example 'disabled' for PixelSegmented."}
        </pre>
      );
    }
    return <ExampleComponent />;
...
export const Required: Story = {
  ...
  render: () => {
    ...
    if (!ExampleComponent) {
      return (
        <pre style={{ color: 'crimson' }}>
          {"Missing example 'required' for PixelSegmented."}
        </pre>
      );
    }
    return <ExampleComponent />;
...
export const WithFormName: Story = {
  ...
  render: () => {
    ...
    if (!ExampleComponent) {
      return (
        <pre style={{ color: 'crimson' }}>
          {"Missing example 'with-form-name' for PixelSegmented."}
        </pre>
      );
    }
    return <ExampleComponent />;
