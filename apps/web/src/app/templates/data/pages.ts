...
export const FULL_PAGE_TEMPLATES: FullPageTemplate[] = [
  {
    ...
    description: 'Complete SaaS landing with hero, features, pricing cards, FAQ, and CTA footer.',
    icon: '🚀',
  ...
  },
  {
    ...
    description: 'Personal portfolio with parallax hero, project grid, skill bars, and contact form.',
    icon: '🧑‍💻',
  ...
  {
    id: 'page-indie-game',
    name: 'Indie Game Landing',
    description: 'Game marketing page with animated icons, leaderboard table, and download CTA.',
    icon: '🎮',
  ...
  },
  {
    ...
    description: 'Full dashboard layout with sidebar, stat cards, progress bars, alerts, and user table.',
    icon: '📊',
  ...
  },
  {
    ...
    description: 'Blog homepage with featured article, post grid, newsletter signup, and footer.',
    icon: '📝',
