        ...
        <div className="p-3 space-y-2 overflow-y-auto" style={{ maxHeight: 'calc(75vh - 3rem)' }}>
          ...
          {sections.atmosphere && (
            <div className="space-y-2 pl-1 pb-2">
              ...
              <ConfigSlider label="Light Distance" value={config.lightRenderDistance} onChange={v => onUpdateConfig('lightRenderDistance', v)} min={1} max={config.renderDistance} step={1} color="text-retro-gold/80" displayValue={`${config.lightRenderDistance} chunks`} />
