        ...
        <div className="p-3 space-y-2 overflow-y-auto" style={{ maxHeight: 'calc(75vh - 3rem)' }}>
          ...
          {sections.effects && (
            <div className="space-y-2 pl-1 pb-2">
              ...
              <ConfigSlider label="NPCs Per Chunk" value={config.npcMaxPerChunk} onChange={v => onUpdateConfig('npcMaxPerChunk', v)} min={1} max={15} step={1} color="text-retro-green/80" displayValue={`${config.npcMaxPerChunk}`} />
